...
const SleepStagesGrid: React.FC = () => {
  ...
  return (
    // grid in a wrapper container for responsiveness
    <div className='flex flex-row xs:w-full md:w-10/12 xl:w-10/12
                    h-[517px] overflow-x-auto self-center'>
      <div className='grid grid-cols-layout grid-rows-layout h-[500px] w-[540px] mx-auto'>

          <div
            className='bg-slate-200 rounded-tl-md border-black border-b-2 border-r p-2'
          >
            Stage
          </div>
          <div
            className='bg-slate-200 border-black border-b-2 border-x-2 p-2'
          >
            Type
          </div>
          <div
            className='bg-slate-200 border-black border-b-2 border-x p-2'
          >
            Length
          </div>
          <div
            className='bg-slate-200 rounded-tr-md border-black border-b-2 border-l-2 p-2'
          >
            Characteristics
          </div>
